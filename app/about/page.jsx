...
export default function AboutPage() {
  ...
  return (
    <div className="bg-base-100 text-base-content">
      ...
      {/* Team Section */}
      <section className="py-16 mt-10 text-center max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-base-content mb-20">
          Meet Our Team
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap- px-6 gap-4">
          {[
            {
            ...
            <div key={i} className="bg-base-300 py-6  rounded-xl  transition">
              ...
              <p className="text-base-content text-sm">{member.role}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Success Stories */}
      <section className="py-16 mt-10 bg-base-100 max-w-7xl mx-auto">
      ...
      <section className="relative py-16 bg-green-100 text-center max-w-7xl mx-auto rounded-md">
        ...
        ></div>
        <h2 className="text-3xl font-bold text-black mb-4">How You Can Help</h2>
